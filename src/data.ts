...
import { default as fullEmitenList } from "./full_emiten_list.json";
import { default as customNamesMapping } from "./custom_names_mapping.json";
...
export const INITIAL_NEWS: NewsItem[] = [
  ...
  {
    id: "news_merger_1",
    title: "Rencana Konsolidasi Besar: Rencana Merger Bank Swasta Menengah Mende